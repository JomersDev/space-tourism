...
export default function Nav() {
    ...
    return (
        <nav className="mx-6 mt-4 flex items-center justify-between md:pt-0 md:mx-0 md:mt-0 xl:mt-10 z-0">
            ...
            <span className="z-10 absolute right-[48rem] bg-[#8B8B90]/75 h-[1px] w-[29.6rem] invisible 2xl:visible"></span>
